...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elscreen-separate-buffer-list" '("esbl-")))

;;;***

;;;### (autoloads nil nil ("elscreen-separate-buffer-list-pkg.el")
;;;;;;  (0 0 0 0))
