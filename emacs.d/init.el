...
(custom-set-variables
 ...
 '(minimap-major-modes (quote (cuda-mode prog-mode)))
 '(minimap-mode nil)
 '(org-agenda-files
   (quote
 ...
 '(package-selected-packages
   (quote
    (smart-mode-line-powerline-theme smart-mode-line-atom-one-dark-theme smart-mode-line org-noter org-pdfview pdf-tools powerline counsel-etags undo-propose poet-theme org-dashboard yaml-mode doom-themes flycheck-haskell interleave minimap flycheck-rust org-plus-contrib offlineimap csv-mode haskell-mode ein rust-mode flycheck-ycmd company-ycmd ycmd flycheck auctex xpm keychain-environment markdown-mode markdown-mode+ company-c-headers company-irony-c-headers company-irony typescript-mode irony ac-c-headers google-this auto-complete-c-headers auto-complete-auctex helm list-packages-ext ox-pandoc pandoc pandoc-mode babel company twilight-anti-bright-theme eyebrowse neotree projectile auto-complete magit color-theme-sanityinc-tomorrow ## solarized-theme auctex-lua exec-path-from-shell auctex-latexmk cdlatex elscreen-multi-term elscreen-persist elscreen-separate-buffer-list git gitter gnuplot latex-extra latex-math-preview latex-unicode-math-mode org-random-todo org-readme org-ref)))
 '(tool-bar-mode nil))
