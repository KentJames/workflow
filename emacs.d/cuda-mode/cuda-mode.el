...
;; I personally think that the base cuda library types and
;; built-ins should be included as primitives/builtins.
;; CUDA is literally unusable without them for the most
;; part, thus idealogically and pragmatically they should be defined here.

;; Arguably, thrust should also be defined here.

;; CUDA FFT Library
(defconst cuda-fft-types
  '("cufftHandle"
    "cufftComplex" "cufftDoubleComplex"
    "cufftReal" "cufftDoubleReal"))

(defconst cuda-fft-builtins
  '())


;; CUDA Complex Library
;; Many of these are typedefs of primitive vector types.
(defconst cuda-complex-types
  '("cuComplex" "cuFloatComplex" "cuDoubleComplex"))

(defconst cuda-complex-builtins
  '())

;; CUBLAS Library
(defconst cuda-blas-types
  '("cublasHandle_t" "cublasStatus_t"
    "cublasOperation_t" "cublasFillMode_t"
    "cublasDiagType_t" "cublasSideMode_t"
    "cublasPointerMode_t" "cublasAtomicsMode_t"
    "cublasGemmAlgo_t" "cublasMath_t"))
;; finish this - laborious
(defconst cuda-blas-builtins
  '("cublasCreate" "cublasDestroy"
    "cublasGetVersion" "cublasGetProperty"
...
;; CUDA Base Primitives
(defconst cuda-primitive-types
   '("dim3"
     "char1" "uchar1" "char2" "uchar2" "char3" "uchar3" "char4" "uchar4"
     "short1" "ushort1" "short2" "ushort2" "short3" "ushort3" "short4" "ushort4"
     "int1" "uint1" "int2" "uint2" "int3" "uint3" "int4" "uint4" "int8_t" "int16_t"
     "long1" "ulong1" "long2" "ulong2" "long3" "ulong3" "long4" "ulong4" "uint8_t" "uint16_t"
     "float1" "float2"  "float3" "float4"
     "double1" "double2" "cudaStream_t"))
...
;; Hit blend..
(defconst cuda-concat-types
  (append cuda-primitive-types (append cuda-blas-types (append cuda-complex-types cuda-fft-types))))

(defconst cuda-concat-builtins
  (append cuda-builtins (append cuda-blas-builtins (append cuda-complex-builtins cuda-fft-builtins))))
...
(setq cuda-builtins-regexp (regexp-opt cuda-concat-builtins 'symbols))
